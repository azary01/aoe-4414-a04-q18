...
#  Converts a set of ECI coordinates at a given time to the respective ECEF coordinates
# Parameters:
#  year
#  month
#  day
...
#  minute
#  second
#  eci_x_km: x coordinate of the object in ECI frame
#  eci_y_km: y coordinate of the object in ECI frame
#  eci_z_km: z coordinate of the object in ECI frame
# Output:
#  Print the ecef coordinates for the given eci position
#
...
r_x = eci_x_km*math.cos(GMST)+eci_y_km*math.sin(GMST)
r_y = eci_y_km*math.cos(GMST)-eci_x_km*math.sin(GMST)
r_z = eci_z_km
